...
export const DEFAULT_TIMEOUTS = {
	// LEPUS execution
	lepus: {
		createContext: 3000,      // 3 seconds (LEPUS is faster)
		executeCode: 25000,       // 25 seconds
		garbageCollection: 500,   // 500ms
		handleCleanup: 300,       // 300ms
		contextSetup: 1000        // 1 second
	},
...
export class TimeoutManager {
	 ...
	 * @param {string} key - Operation key (e.g., 'lepus.executeCode')
...
export function createTimeoutContext(options = {}) {
	...
	return {
		...
		lepus: () => manager.getCategory('lepus'),
